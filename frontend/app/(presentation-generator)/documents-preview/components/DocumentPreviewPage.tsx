  ...
  const maintainDocumentTexts = async () => {
    ...
    documentKeys.forEach(key => {
      if (!(key in textContents)) {
        ...
        // For web mode, we'll return the document path as content since we can't read arbitrary files
        // In a real implementation, you might want to store document content during upload
        promises.push(Promise.resolve(`Document: ${documents[key]}\n[Content would be displayed here in a full implementation]`));
      }
    });
